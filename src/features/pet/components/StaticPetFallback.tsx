...
interface StaticPetFallbackProps {
  petState: PetState;
}

export function StaticPetFallback({ petState }: StaticPetFallbackProps): React.ReactElement {
  const config = VISUAL_CONFIGS[petState] ?? VISUAL_CONFIGS.idle;
